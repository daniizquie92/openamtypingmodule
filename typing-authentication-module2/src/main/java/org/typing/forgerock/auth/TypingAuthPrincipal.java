 ...
 */
public class TypingAuthPrincipal implements Principal, Serializable {
    private final static String COLON = " : ";

    private final String name;

    public TypingAuthPrincipal(String name) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TypingAuthPrincipal)) {
            return false;
        }
        TypingAuthPrincipal that = (TypingAuthPrincipal) o;
